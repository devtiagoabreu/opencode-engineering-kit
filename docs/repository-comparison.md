...
- **Estado atual:** 134 skills (42 categorias), 103 agents (personas em 38 categorias), 10 prompts,
...
- **Onde este kit é melhor:** amplitude de **conteúdo de domínio** (134 skills e 103 personas, inclusive
...
- **Onde este kit é melhor:** escala (134 vs 62 skills; 103 personas que o Shokunin não tem),
...
- **Onde este kit é melhor:** licença realmente aberta (MIT, redistribuível), escala (134 vs ~20),
...
| **Conteúdo** | 134 skills autorais + 103 personas (pt-BR/EN) com procedência e testes | Consome skills do ClawHub (~13k, curadoria ainda em maturação) |
