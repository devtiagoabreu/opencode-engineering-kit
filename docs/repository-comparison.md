...
- **Estado atual:** 133 skills (42 categorias), 103 agents (personas em 38 categorias), 10 prompts,
...
- **Onde este kit é melhor:** amplitude de **conteúdo de domínio** (133 skills e 103 personas, inclusive
...
- **Onde este kit é melhor:** escala (133 vs 62 skills; 103 personas que o Shokunin não tem),
...
- **Onde este kit é melhor:** licença realmente aberta (MIT, redistribuível), escala (133 vs ~20),
...
| **Conteúdo** | 133 skills autorais + 103 personas (pt-BR/EN) com procedência e testes | Consome skills do ClawHub (~13k, curadoria ainda em maturação) |
